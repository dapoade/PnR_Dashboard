...
st.sidebar.caption(" *Versatility Rating* is a measure of how many different coverages a player or team plays. Metric is based on tendency, not effectiveness, with 1 being more versatile and 0 being the least versatile.")
